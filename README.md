...
| **Canonical documents** — foundations, new in v3.59.0 (on screen since v3.65.1: **Documents**) | Architecture, decisions, conventions, roadmap — verbatim | **Replaced whole** — since v3.68.0 added through two doors, **Add from this computer** and **Add from GitHub**, always both, matched to the project's one source; written by an agent you asked, or written or edited by you directly, in the app | The document an agent should not start work without |
