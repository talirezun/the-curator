...
│   │   │                       — v3.61.2). Never renders a prompt, never calls an LLM. Two callers:
...
│   │   │                       manifest entry and copy since v3.61.2, which is a decision to stop
...
| # | Item | Enabled | Notes |
|---|---|---|---|
| 1 | `Working on: lumina · 12 min ago` | **yes** | the headline answer, and since v3.48.0 it names the most recently saved PROJECT; clicking opens Agent memory |
