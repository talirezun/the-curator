...
*Shown on the synthetic demo workspace; `node scripts/screenshots.mjs` regenerates it. The five sections run top to bottom — Ingest, Pages, Projects, Shared Brain and Wiki health; the first two are in view.*
