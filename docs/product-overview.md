...
*The INGEST section of a domain page with a batch staged; the same panel is also a full-page view. Shown on the synthetic demo workspace; `node scripts/screenshots.mjs` regenerates it.*
...
*Shown on a synthetic demo domain; `node scripts/screenshots.mjs` regenerates it.*
