...
| ③ | **Knowledge** | One row per wiki the project draws on, each opening that wiki's figures and two doors, *Open in Domains* and *Ask this domain* — with a **+ Add a wiki** picker in the head row |
