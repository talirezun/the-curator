...
- **After setup, daily use is unchanged.** Click **Sync now** in the Sync tab (or have your agent `POST /api/sync/sync`). See [sync.md → Daily workflow](sync.md#daily-workflow).
