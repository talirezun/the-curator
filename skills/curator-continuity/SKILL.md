...
- **If the user wants a standing instruction changed, that is a human edit** to `state/project.md` in the app or in Obsidian (§1). Never try to route it through `save_working_state`, and never report something you decided this session as though the brief now says it.
