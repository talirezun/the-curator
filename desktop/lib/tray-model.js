 ...
 * "a hostname that flapped under DHCP (`mac-17d23c` vs
 * `talis-macbook-pro-17d23c`) is still caught by the id arm underneath."
 *
 ...
 * arm, the other falls through to `id:17d23c`, and the pair lands in two
...
export function buildTrayModel(summary, opts = {}) {
  ...
  // characters of an identity, beside an intact `talis-macbook-pro·17d2`. The
