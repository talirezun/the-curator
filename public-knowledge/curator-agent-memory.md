...
| "that save wrote the handoff in full — what got shortened is a label" | Only a label was clipped, most often the one-line headline | Nothing urgent. A clipped headline is a weaker index entry, worth a shorter re-save |
